...
// Styling for the Modal(A Modal is just the box that appears when you press a button)
const style = {
  position: 'absolute',
  top: '50%',
  left: '50%',
...
const [itemName, setItemName] = useState('')
  ...
  return (
    ...
    <Box width="800px" height="100px" bgcolor={'#addde6'}>
